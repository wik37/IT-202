...
$ratings = [];
//$stmt = $db->prepare("SELECT product_id, user_id, Ratings.rating, comment, Ratings.created, username, Products.name from Ratings LEFT JOIN Users on Ratings.user_id = Users.id LEFT JOIN Products ON Ratings.product_id = Products.id where user_id = :id");

$base_query = "SELECT product_id, user_id, Ratings.rating, comment, Ratings.created, username, Products.name from Ratings LEFT JOIN Users on Ratings.user_id = Users.id LEFT JOIN Products ON Ratings.product_id = Products.id where user_id = :id";
$total_query = "SELECT count(*) as total from Ratings where user_id = :id";
            ...
            <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapse<?php echo $c; ?>" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-heading<?php echo $c; ?>">
                    <div class="accordion-body">
                        ...
                        <a href="product_details.php?product=<?php se($rating, 'product_id') ?>"> view <strong><?php se($rating, 'name') ?></strong> product page</a>
                    </div>
                </div>
            </div>
            <?php $c += 1; ?>
